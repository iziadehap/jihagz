<<<<<<< HEAD:lib/features/details/data/data_source/details_controller.dart
...
class DetailsController extends GetxController {
  ...
  Future<void> fetchRatingDistribution(String stadiumId) async {
    if (kDemoMode) {
      ratingDistribution.value = Map<int, int>.from(
        MockData.demoRatingDistribution,
      );
      return;
    }
  ...
  Future<void> loadUserRating(String stadiumId) async {
    if (kDemoMode) {
      userRating.value = 4.0;
      userRateFromServer.value = 4.0;
      ratingLoading.value = false;
      return;
    }
...
>>>>>>> 348ea1d (update):lib/features/details/controllers/details_controller.dart
